...
def test_store_telemetryack_message():
    line = '[2023-07-28 21:44:39.700] [network_processed] [trace] "message_received" message: { header: { type: "telemetry_ack", network: "test", network_int: 21080, version: 19, version_min: 18, version_max: 19, extensions: 202 }, data: {  } }'
    properties = COMMON_PROPERTIES
...
def test_store_telemetryreq_message():
    line = '[2023-07-28 21:44:30.798] [network_processed] [trace] "message_received" message: { header: { type: "telemetry_req", network: "test", network_int: 21080, version: 19, version_min: 18, version_max: 19, extensions: 0 } }'
    properties = COMMON_PROPERTIES
...
def test_store_asc_pull_req_message():
    ...
    line = '[2023-08-08 19:10:00.332] [network_processed] [trace] "message_received" message: { header: { type: "asc_pull_req", network: "test", network_int: 21080, version: 19, version_min: 18, version_max: 19, extensions: 34 }, type: "blocks", id: 11410925922915025654, start: "42FBDAD4C956B3E2B6576E85C14CFA6D4C8A007E497BDDAA6F23E741A3F56CFF", start_type: "block", count: 128 }'
    properties = COMMON_PROPERTIES + [
