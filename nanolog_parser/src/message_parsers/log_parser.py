...
class MessageTypeIdentifier(IMessageTypeIdentifier):
    ...
    def __init__(self):
        self.common_pattern = {
            ...
            ('channel_send', 'confirm_ack'): ConfirmAckMessageSent,
            ('channel_send', 'confirm_req'): ConfirmReqMessageSent,
            ('channel_send', 'publish'): PublishMessageSent,
            ('channel_send', 'keepalive'): KeepAliveMessageSent,
            ('channel_send', 'asc_pull_ack'): AscPullAckMessageSent,
            ('channel_send', 'asc_pull_req'): AscPullReqMessageSent,
            ('channel_send', 'node_id_handshake'): NodeIdHandshakeMessageSent,
            ('channel_send', 'telemetry_req'): TelemetryReqMessageSent,
            ('channel_send', 'telemetry_ack'): TelemetryAckMessageSent,
            ('channel_send', 'bulk_pull_account'): BulkPullAccountMessageSent,
            ('channel_send', 'frontier_req'): FrontierReqMessageSent,
            ('channel_send', 'bulk_push'): BulkPushMessageSent,
